...
\input{_autogen/phase_a_table.tex}
...
\input{_autogen/phase_b_table.tex}
...
and smaller on MNIST (mean $-9.4$ pp). This is expected: v1 Phase B
combined the post-upsample noise / salt-and-pepper bug with the
correctly-implemented resolution / blur / saturation, so v1 numbers
on Phase B were inflated by exactly the amount the noise / S\&P
contributions had been under-counted.

\subsection{Phase C — Single-Axis Isolation}
\label{sec:results_phase_c}

\input{_autogen/phase_c_l5_table.tex}
