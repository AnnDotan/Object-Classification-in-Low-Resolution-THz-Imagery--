...
% the literal Unicode (visible in editors but not typeset RTL).
% ====================================================================
\IfFileExists{polyglossia.sty}{
  ...
  % pdflatex fallback: include the Unicode source verbatim. The DOCX
  % build (Pandoc + reference template) still renders the Hebrew
  % correctly because Pandoc walks the source text directly.
  \begingroup
