...
def run_final_plan(
    *,
    ...
    # `--dry-run` resolves CellSpecs (no training) and exits.
    if dry_run:
        print("=" * 72)
    ...
    # TransNeXt cells dispatch alongside CNN cells. `is_quarantined` is a
    # no-op predicate (always False) so tracker / Optuna code that still
    # calls it continues to work without quarantining anything.
