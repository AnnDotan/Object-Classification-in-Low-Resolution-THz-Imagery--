...
> TransNeXt rows are quarantined per `docs/prds/PHASE_B_VISUAL_CORE.md` US-014 and excluded from execution. They remain in the matrix so the 186 denominator is preserved.
